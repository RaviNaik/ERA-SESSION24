...
Config.set("graphics", "width", "1575")
Config.set("graphics", "height", "781")
...
def init():
    ...
    img = PILImage.open("./images/tokyo_mask.png").convert("L")
...
class CarApp(App):
    def build(self):
        ...
        print(f"************{parent.width}, {parent.height}***************")
        clearbtn = Button(text="clear", pos=(0, 7 * parent.height))
        savebtn = Button(text="save", pos=(parent.width, 7 * parent.height))
        loadbtn = Button(text="load", pos=(2 * parent.width, 7 * parent.height))
